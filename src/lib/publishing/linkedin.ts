...
async function registerImageUpload(authorUrn: string): Promise<RegisteredImageUpload> {
...
async function uploadImage(authorUrn: string, image: PublishImagePayload): Promise<string> {
